...
//好友資訊
  $sql1 = "
select distinct T.MEMBER_NO MEMBER_NO ,T.FRIENDS_NO FRIENDS_NO, MM.MEMBER_NAME FRIENDS_NAME ,mm1.MEMBER_NAME MEMBER_NAME, MM.MEMBER_IMAGE FRIENDS_IMAGE , mm1.MEMBER_IMAGE MEMBER_IMAGE  from track_list T
